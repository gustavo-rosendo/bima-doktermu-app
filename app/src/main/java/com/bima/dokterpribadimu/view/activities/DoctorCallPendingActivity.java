...
import com.bima.dokterpribadimu.databinding.ActivityDoctorCallPendingBinding;
...
public class DoctorCallPendingActivity extends BaseActivity {

    private ActivityDoctorCallPendingBinding binding;
    private DrawerFragment drawerFragment;

    private static final String TAG = DoctorCallPendingActivity.class.getSimpleName();
...
//    private Tracker mTracker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doctor_call_pending);
...
//        mTracker.send(new HitBuilders.ScreenViewBuilder().build());
    ...
    private void init() {
        initViews();
        setupDrawerFragment();
        setupDoctorCallPendingFragment();
    }
    ...
    private void setupDoctorCallPendingFragment() {
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction
                .replace(R.id.fragment_container, DoctorCallPendingFragment.newInstance())
                .commit();
    }
}
